import { Terminal, LayoutDashboard, Ticket, Users, ScrollText, Zap, LogOut, Activity, BarChart3, Building2, Home, Cable } from 'lucide-react';
...
const adminItems = [
  ...
  { title: 'Trânsito & Transporte', url: '/transits', icon: Cable },
